Warning: truncated output (original token count: 90044)
Total output lines: 8896
    ...
    try:
        ...
        if start_at < timezone.now():
            ...
            if existing_waitlist:
                ...
                disabled_reason = "このレッスンは満員です。キャンセル待ち登録が…40044 tokens truncated… "lesson_type_display": _lesson_type_label(obj.lesson_type),
