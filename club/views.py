Warning: truncated output (original token count: 91511)
Total output lines: 9016
    ...
    try:
        ...
        for choice in participant_choices:
            ...
            if is_booked:
                ...
                choice[…41511 tokens truncated… "lesson_type_display": _lesson_type_label(obj.lesson_type),
